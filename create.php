...
<?php
  ...
  $resultado = mysqli_query($conexao, "INSERT INTO clientes(nome, idade, login, senha) VALUES ('".$nome."',".$idade.",".$login.",".$senha.")") or die("Não foi possível executar a SQL: ".mysqli_error($conexao));

    ...
    <head>
       ...
       <meta http-equiv="X-UA-Compatible" content="IE=edge">
        ...
        <link rel="stylesheet" type="text/css" href="css/escudo.css"/>
        <title> Escudo </title>    
    </head>
        <body>
        <header>
        ...
        <script src="js/bootstrap.min.js"></script>  
          ...
          <aside id="nave">
           <ul class="nav nav-pills nav-stacked">
            ...
            <section id="artigo">
                <div id="escudo"> 
                <img src="imgsp/Escudo.png" height="300" width="300" />
                </div>

                <div id="artigo1">
                <p>
                No escudo do Corinthians as 4 estrelas amarelas representam os 4 títulos brasileiros, enquanto a estrela amarela com borda prateada em destaque representa o Mundial de Clubes da Fifa de 2000.

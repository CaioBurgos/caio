    ...
    <head>
      ...
      <meta content="Author" content="Caio Burgos 41512650"/> 
       <meta http-equiv="X-UA-Compatible" content="IE=edge">
        ...
        <link rel="stylesheet" type="text/css" href="css/tabela%20brasileiro.css"/>
        <title> Tabela Brasileirão 2016 </title>    
    </head>
        <body>
        <header>
      ...
      <div class="container-fluid">
        ...
        <script src="js/bootstrap.min.js"></script>  
          ...
          <aside id="nave">
            ...
            <section>
                <h4 id="titulo2">Notícias do momento</h4>
                <img id="img2" src="imgsp/26-rodada-tabela.JPEG"/>
                <img id="img3" src="imgsp/saopaulo1.png"/>
          </section>

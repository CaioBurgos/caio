      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="#">Fe Franco - Kaique</a></li>
                <li><a href="#">Bruno - Jonatas</a></li>
                <li><a href="#">Japa - Thomas</a></li>
                <li><a href="#">Leo</a></li>  
        ...
        <script src="js/bootstrap.min.js"></script>  
          ...
          <aside id="nave">
            ...
            <section id="artigo">
            <img id="leco" src="imgsp/Leco.JPEG" height="300" width="300"/>
            <div id="artigo1">
            <p>
            <h1>Roberto de Andrade é eleito o novo presidente do Corinthians</h1>
            Depois de uma das mais acirradas eleições da história do Corinthians, Roberto de Andrade, da chapa situacionista Renovação e Transparência, foi eleito o novo presidente do clube, com 1848 votos, para um mandato de três anos. Ele venceu a disputa contra Antonio Roque Citadini, da chapa de oposição Pró-Corinhtians, que recebeu 1393 votos. 
Realizado das 9h às 17h, o pleito aconteceu no ginásio principal do Parque São Jorge. No poder do clube desde outubro de 2007, a chapa da situação ainda terá André Luiz de Oliveira e Jorge Kalil como vice-presidentes. 
Roberto de Andrade é conselheiro vitalício do Timão. Foi vice de Andrés Sanchez na eleição de 2009 e assumiu o departamento de futebol do Corinthians no final de 2010. Se afastou da função em fevereiro de 2014 para dar início a sua candidatura.
            </p>
            </div>

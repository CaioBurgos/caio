    ...
    <head>
       <meta charset="utf-8"/>
       <meta content="Author" content="Caio Burgos dos Santos"/>  
       <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link href="css/bootstrap.min.css" rel="stylesheet">
        <link rel="stylesheet" type="text/css" href="css/elenco.css"/>
        <title> Elenco </title>    
    </head>
        <body>
        <header>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li><a href="Historia.html">História <span class="sr-only">(current)</span></a></li>
             <li class="dropdown">
            ...
            <li><a href="cad_index.html">Faça Seu Cadastro</a></li> 
    ...
    <ul class="nav navbar-nav navbar-right">
          ...
          <aside id="nave">
             ...
             <li role="presentation"><a href="Historia.html">História</a></li>
             <li role="presentation"><a href="http://www.radiocoringao.com.br/">Radio</a></li>
             <li role="presentation"><a href="/Tabela_Brasileiro.php">Tabela</a></li>
            ...
            <section id="artigo">
            <div ><img id="elenco" src="imgsp/Elenco.JPEG" height="400" width="800"/></div>
            <div id="artigo1">
            <p>
            </br> 
           Corinthians:  Goleiros: Matheus Vidotto, Cássio,Walter, Caique França, Douglas Friedrich
        Laterais: Uendel, Guilherme Arana, Fagner  
        Zagueiros: Yago, Balbuena, Léo Santos, Vilson,Pedro Henrique 	
        Volantes: Willians, Cristian, Jean, Marciel, Camacho, Warian
        Meias: Marlone, Guilherme,Giovanni Augusto, Danilo, Rodriguinho, Marquinhos Gabriel, Rodrigo Figueiredo
        Atacantes: Gustavo, Ángel Romero, Léo Jabá , Rildo , Carlinhos, Isaac, Lucca, Bruno Paulo, Gabriel Vasconcelos 

            </br>
        Goleiros: Matheus Vidotto, Cássio,Walter, Caique França, Douglas Friedrich
        Laterais: Uendel, Guilherme Arana, Fagner  
        Zagueiros: Yago, Balbuena, Léo Santos, Vilson,Pedro Henrique 	
        Volantes: Willians, Cristian, Jean, Marciel, Camacho, Warian
        Meias: Marlone, Guilherme,Giovanni Augusto, Danilo, Rodriguinho, Marquinhos Gabriel, Rodrigo Figueiredo

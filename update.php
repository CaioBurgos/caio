...
<?php
  ...
  $resultado = mysqli_query($conexao, "UPDATE clientes SET nome='".$nome."', idade=".$idade.", senha=".$senha." WHERE login=".$login) or die("Não foi possível executar a SQL: ".mysqli_error($conexao));
